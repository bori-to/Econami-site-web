                    ...
                    <div class="card-wrapper">
                        <div class="card fat">
                            <div class="card-body">
                                ...
                                <form method="POST" class="my-login-validation" action="oubli_verif_key.php" novalidate="">
                                    <div class="form-group">
                                        <label for="key1">Clé</label>
                                        <input id="key1" type="text" class="form-control" name="key1" required autofocus>
                                        <div class="form-text text-muted">
                                            Entrez la clé de modification
                                        </div>
                                    </div>

                                    <div class="form-group m-0">
                                        <button type="submit" class="btn btn-dark btn-block" onclick="window.location.href='oubli_verif_key.php'">
                                            Valider
                                        </button>
                                    </div>
                                </form>
