                    ...
                    <div class="card-wrapper">
                        <div class="card fat">
                            <div class="card-body">
                                ...
                                <form method="POST" class="my-login-validation" action="oubli_modif_sql.php" novalidate="">
                                    ...
                                    <div class="form-group">
                                        <label for="mot de passe">Confirmer le nouveau mot de passe</label>
                                    ...
                                    <div class="form-group m-0">
                                        <button type="submit" class="btn btn-dark btn-block" onclick="window.location.href='oubli_modif_sql.php'">
                                            Valider
                                        </button>
                                    </div>
                                </form>
